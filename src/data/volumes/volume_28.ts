...
export const volume_28: Volume = {
  "id": "28",
  "number": 28,
  "slug": "lords-prayer",
  "title": "Lord's Prayer",
  "subtitle": "The Master Pattern for Christian Prayer & Kingdom Life",
  "overview": "A clause-by-clause theological and devotional breakdown of the model prayer Jesus gave His disciples in Matthew 6 and Luke 11.",
  "category": "devotional",
  ...
  "metaDescription": "Clause-by-clause commentary on the Lord's Prayer: Our Father in heaven, hallowed be Your name, daily bread, forgiveness, temptation, and the doxology explained.",
  "keywords": [
    "lords prayer meaning",
    "our father prayer commentary",
    "matthew 6 lords prayer",
    "hallowed be your name",
    "daily bread meaning",
    "lead us not into temptation"
  ],
  "articleLink": "https://goshsays.blogspot.com/2026/01/the-lords-prayer-complete-exposition.html",
  "youtubeLink": "https://youtu.be/81Xm-v0fF54",
  "youtubeStatus": "scheduled",
  "youtubePublishDate": "2026-12-17",
  "relatedVolumes": [
    "sermon-on-the-mount",
  ...
  "summary": "The Lord's Prayer is the master paradigm of prayer provided by Christ in the Sermon on the Mount. Arranged into seven petitions, it teaches believers to reorient their desires toward God's glory and Kingdom before presenting personal petitions for provision, pardon, and protection.",
  "keyFacts": [
    "The address 'Our Father' (Abba) reflects intimate covenant adoption, balanced immediately by 'in heaven' asserting transcendent majesty.",
    "The first three petitions ('Your name,' 'Your kingdom,' 'Your will') prioritize God's eternal purposes over personal human agendas.",
    "The middle petition for 'daily bread' (epiousios) teaches present-day reliance on divine providence, recalling the wilderness manna.",
    "The petition 'forgive us our debts as we forgive' links receiving divine forgiveness with an obligation to extend mercy to others."
  ],
  "faq": [
    {
      "q": "What is the meaning of 'Hallowed be Your name'?",
      "a": "It is a petition that God's name, reputation, and holy character would be honored, revered, and held in supreme esteem across our lives and the entire world."
    },
    {
      "q": "Why does Jesus say 'Give us this day our daily bread'?",
      "a": "The unique Greek word epiousios refers to bread 'for tomorrow' or 'sufficient for this day,' teaching believers to avoid anxiety by trusting God day by day."
    },
    {
      "q": "Does God tempt people to sin when we pray 'lead us not into temptation'?",
      "a": "James 1:13 affirms that God tempts no one; the petition asks God to graciously spare us from severe testing or trials that could overwhelm our spiritual strength."
    },
    {
      "q": "Is the concluding doxology ('For Yours is the kingdom...') in original manuscripts?",
      "a": "While absent from the earliest Greek manuscripts of Matthew, it was early adopted by the Apostolic Church (found in the Didache) as a fitting liturgical conclusion drawn from 1 Chronicles 29:11."
    }
  ],
  "content": {
    ...
    "tables": [
      {
        ...
        "rows": [
          [
            "God's Glory (Thy-section)",
            "The Name, Kingdom, and Will of God",
            "Vertical: Priority of God's Honor"
          ],
          [
            "Our Needs (Us-section)",
            "Provision, Pardon, and Protection",
            "Horizontal: Human Dependence on Grace"
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            "Liturgical",
            "Recited three times daily in many early communities (Didache)."
          ],
          [
            "Baptismal",
            "Taught to new converts as the \"Prayer of the Faithful.\""
          ],
          [
            "Warfare",
            "Used as a shield against demonic oppression and temptation."
          ],
          [
            "Communal",
            "The primary prayer that united diverse house churches."
          ]
        ]
      }
    ],
