...
export const volume_38: Volume = {
  "id": "38",
  "number": 38,
  "slug": "psalm-authors",
  "title": "Psalm Authors",
  "subtitle": "David, Asaph, the Sons of Korah, Moses, and Solomon",
  "overview": "A historical and literary study of the psalmists who penned Israel's prayer book: Davidic laments, Asaph's wisdom, Korahite hymns, and liturgical divisions.",
  "category": "scholarly",
  ...
  "metaDescription": "Who wrote the Psalms? Discover David, Asaph, the Sons of Korah, Moses (Psalm 90), Heman, Ethan, and Solomon. Learn psalm genres, laments, and liturgical theology.",
  "keywords": [
    "who wrote the psalms",
    "psalm authors",
    "sons of korah psalms",
    "asaph psalms meaning",
    "davidic psalms",
    "types of psalms laments praise"
  ],
  "articleLink": "https://goshsays.blogspot.com/2026/01/the-psalm-authors-complete-guide-to-who.html",
  "youtubeLink": "https://youtu.be/V0-aZkL1x6T",
  "youtubeStatus": "scheduled",
  "youtubePublishDate": "2027-01-23",
  "relatedVolumes": [
    "bible-book-writers",
  ...
  "summary": "Psalm Authors explores the diverse inspired voices behind the 150 lyrical poems comprising the Hebrew Psalter. It profiles King David, Asaph the temple choir leader, the guild of the Sons of Korah, Moses, and Solomon, outlining the five liturgical books mirroring the Pentateuch.",
  "keyFacts": [
    "King David is attributed with authorship of at least 73 individual psalms, emerging from seasons of shepherd isolation, royal triumphs, and agonizing penitence.",
    "Asaph, appointed by David as chief musician, authored 12 psalms (Psalm 50, 73–83) focusing on social justice, divine sovereignty, and national lament.",
    "The Sons of Korah—descendants of the rebel who was swallowed by the earth—were redeemed into a hereditary guild of temple musicians authoring 11 psalms.",
    "Moses is the author of Psalm 90, the oldest psalm in the collection, meditating on God's eternity and the brief transience of human life."
  ],
  "faq": [
    {
      "q": "Why is the Book of Psalms divided into five books?",
      "a": "The fivefold division (Book I: 1–41, Book II: 42–72, Book III: 73–89, Book IV: 90–106, Book V: 107–150) intentionally parallels the five books of Moses (the Torah), presenting the Psalter as Israel's devotional response to God's Law."
    },
    {
      "q": "Who were the Sons of Korah?",
      "a": "Korah led a rebellion against Moses in Numbers 16 and was judged, but his sons were spared; generations later, his descendants served faithfully as gatekeepers and master musicians in the tabernacle and temple."
    },
    {
      "q": "What is an imprecatory psalm?",
      "a": "Imprecatory psalms (e.g., Psalm 35, 69, 109) are passionate prayers that appeal to God's holy justice against violent, unrepentant oppressors, releasing vengeance into God's hands rather than taking personal revenge."
    },
    {
      "q": "What does the musical term 'Selah' mean?",
      "a": "While its precise technical meaning is debated, Selah most likely functioned as a musical pause, liturgical interlude, or invitation for worshippers to stop and deeply ponder the preceding lyric."
    }
  ],
  "content": {
    ...
    "tables": [
      ...
      {
        "title": "THE FIVE BOOKS OF PSALMS (TORAH STRUCTURE)",
        "headers": [
          "Book",
          "Psalms",
          "Torah Parallel",
    ...
    "storyPanels": [
      {
        "id": "ps-1",
        "title": "The Shepherd’s Harp",
        "description": "Young David tending sheep in the Judean wilderness, composing songs of trust that would one day lead a nation.",
        "scripture": "Psalm 23:1",
        "imagePrompt": "A young man with a small wooden harp sitting in a lush green valley with sheep nearby, sunlight filtering through olive trees, peaceful and pastoral atmosphere.",
        "colorTheme": "#4CAF50",
        "era": "Kingdom"
      },
      {
        ...
        "description": "The Sons of Korah leading the assembly in a powerful song of ascent at the Temple gates.",
        "scripture": "Psalm 84:1",
        "imagePrompt": "A group of men in white linen robes singing on massive stone steps, holding lyres and cymbals, the golden Temple shining in the background at sunset.",
        "colorTheme": "#D4AF37",
        "era": "Kingdom"
      }
    ],
    "timeline": [
      ...
      {
        "year": "450 BC",
        "event": "Ezra and the Great Assembly finalize the \"Psalter\" into its current five-book structure.",
        "color": "#2196F3",
        "era": "Restoration"
      }
    ],
