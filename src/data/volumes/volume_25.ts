...
export const volume_25: Volume = {
  "id": "25",
  "number": 25,
  "slug": "holy-communion",
  "title": "Holy Communion",
  "subtitle": "The Lord's Supper, Eucharistic Theology & the New Covenant Meal",
  "overview": "The biblical institution, liturgical practice, and theological interpretations of the Lord's Supper: Transubstantiation, Consubstantiation, Real Presence, and Memorialism.",
  "category": "scholarly",
  ...
  "metaDescription": "Explore Holy Communion and the Lord's Supper: Biblical Passover roots, 1 Corinthians 11, Transubstantiation, Consubstantiation, Spiritual Presence, and Memorialism.",
  "keywords": [
    "holy communion theology",
  ...
  "articleLink": "https://goshsays.blogspot.com/2026/01/holy-communion-complete-theological.html",
  "youtubeLink": "https://youtu.be/J6Y2qM7F_ls",
  "youtubeStatus": "scheduled",
  "youtubePublishDate": "2026-12-06",
  "relatedVolumes": [
  ...
  "summary": "Holy Communion examines the sacred covenant meal instituted by Jesus Christ in the Upper Room on the night before His crucifixion. It analyzes the Passover roots of the bread and cup, and compares the historic Western Catholic, Lutheran, Reformed, and Baptist views on Christ's presence in the elements.",
  "keyFacts": [
    "Jesus transformed the traditional Jewish Passover Seder by presenting the unleavened bread as His broken body and the wine as the blood of the New Covenant.",
    "Four major Eucharistic views exist: Transubstantiation (Rome), Consubstantiation (Luther), Spiritual Real Presence (Calvin), and Memorialism (Zwingli).",
    "The Apostle Paul warns in 1 Corinthians 11 against partaking of the Lord's Supper in an unworthy manner without discerning the Lord's body and examining oneself.",
    "Communion looks in three temporal directions: back to the Cross, upward in present spiritual fellowship, and forward to the Marriage Supper of the Lamb."
  ],
  "faq": [
    {
      "q": "What did Jesus mean by 'This is my body'?",
      "a": "Historic Roman Catholicism views this as metaphysical change of substance; Lutherans see Christ present 'in, with, and under' the elements; Reformed view Christ spiritually present by the Spirit; Baptists see a symbolic memorial."
    },
    {
      "q": "What were the Passover connections to the Last Supper?",
      "a": "The bread was the afikoman, unbroken and striped, while the cup was the third cup of the Seder—the Cup of Redemption—signifying liberation from the slavery of sin."
    },
    {
      "q": "What does it mean to take communion 'unworthily'?",
      "a": "In 1 Corinthians 11, taking communion unworthily meant treating the sacred feast flippantly, causing division, humiliating the poor, or harboring unrepentant sin against fellow believers."
    },
    {
      "q": "How often should a church observe Holy Communion?",
      "a": "The New Testament does not mandate a specific frequency, stating only 'as often as you drink it' (1 Cor 11:26); practices range from daily and weekly to monthly or quarterly."
    }
  ],
  "content": {
    ...
    "tables": [
      {
        ...
        "rows": [
          [
            "Transubstantiation",
            "Bread and wine become Christ’s literal body and blood.",
            "Roman Catholic"
          ],
          [
            "Consubstantiation",
            "Christ is “in, with, and under” the elements.",
            "Lutheran"
          ],
          [
            "Spiritual Presence",
            "Christ is spiritually present; believers truly commune with Him.",
            "Reformed / Presbyterian"
          ],
          [
            "Memorialism",
            "Communion is a symbolic remembrance / ordinance.",
            "Baptist / Evangelical / Pentecostal"
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            ...
            "Christ = Passover Lamb (1 Cor 5:7)"
          ],
          [
            "Manna",
            "Heaven-sent bread for life",
            "Jesus = Bread of Life (John 6:35)"
          ],
          [
            "Covenant Meals",
            "Meals that seal peace with God",
            "New Covenant sealed in His blood"
          ],
          [
            "Temple Sacrifices",
            "Blood atonement for sin",
            "Christ's final once-for-all sacrifice"
          ]
        ]
      },
      {
        ...
        "rows": [
          ...
          [
            "Pentecostal",
            "Healing & Spiritual Breakthrough",
            "Variable"
          ]
        ]
      }
