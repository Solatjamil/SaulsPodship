...
export const volume_19: Volume = {
  "id": "19",
  "number": 19,
  "slug": "easter-resurrection",
  "title": "Easter & Resurrection",
  "subtitle": "The Cornerstone of Christian Faith, History & Hope",
  "overview": "The historical evidence, scriptural accounts, theological necessity, and cosmic implications of the physical bodily resurrection of Jesus Christ from the dead.",
  "category": "devotional",
  "lastUpdated": "2026-09-06",
  "heroImage": {
    "src": "/images/volumes/easter-resurrection/hero-1920.jpg",
    "alt": "Public-domain artwork illustrating “Easter & Resurrection”",
    "credit": "Public domain — Matthias Grünewald · Wikimedia Commons"
  },
  "cardImage": {
    "src": "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?auto=format&fit=crop&w=800&q=80",
    "alt": "Easter & Resurrection"
  },
  "metaDescription": "Explore the historical and theological proof of Jesus Christ's bodily resurrection. Understand the empty tomb, eyewitness testimonies, and new creation victory.",
  "keywords": [
  ...
  "summary": "Easter & Resurrection centers on the historical bedrock of the Christian faith: the bodily resurrection of Jesus Christ on the third day. It demonstrates that the empty tomb and apostolic eyewitness testimonies guarantee the believer's justification, victory over death, and future bodily resurrection.",
  "keyFacts": [
    "The Apostle Paul asserts in 1 Corinthians 15:17 that 'if Christ has not been raised, your faith is futile; you are still in your sins.'",
    "Early creedal formulas cited in 1 Corinthians 15:3-7 date to within three to five years of Jesus' crucifixion.",
    "Women are uniformly recorded as the primary eyewitnesses to the empty tomb across all four Gospels, a powerful criterion of historical authenticity.",
    "Christ's resurrection is not merely a resuscitation, but the inauguration of the glorified physical life of the New Creation."
  ],
  "faq": [
    {
      "q": "Why is the resurrection the cornerstone of Christianity?",
      "a": "Without the resurrection, Jesus would be merely an executed teacher; His physical resurrection validates His claims to deity, confirms His sacrifice was accepted by the Father, and conquers death."
    },
    {
      "q": "What evidence exists for the bodily resurrection?",
      "a": "The empty tomb in Jerusalem, multiple independent post-resurrection appearances to individuals and groups of over 500, and the dramatic transformation of cowardly disciples into bold martyrs."
    },
    {
      "q": "Could the disciples have hallucinated Jesus' resurrection?",
      "a": "Hallucinations are private, individual psychological phenomena; the biblical accounts document simultaneous, multi-sensory experiences by diverse groups who spoke with, touched, and ate with Christ."
    },
    {
      "q": "What does Christ's resurrection mean for believers today?",
      "a": "It guarantees that our sins are forgiven, that we possess spiritual resurrection power in the present, and that we will receive glorified, immortal physical bodies at Christ's return."
    }
  ],
  "content": {
    ...
    "tables": [
      {
        ...
        "rows": [
          [
            "Palm Sunday",
            "Triumphal Entry",
            "Jesus enters Jerusalem as the Messianic King."
          ],
          [
            "Monday",
            "Cleansing of the Temple",
            "Jesus asserts authority over God's house."
          ],
          [
            "Tuesday",
            "Teaching in Jerusalem",
            "Final public warnings and parables."
          ],
          [
            "Wednesday",
            "Silent Day",
            "Preparation; Judas agrees to betray Jesus."
          ],
          [
            "Thursday",
            "Last Supper & Gethsemane",
            "Institution of Communion; the agony of prayer."
          ],
          [
            "Friday",
            "The Crucifixion",
            "Jesus dies for the sins of the world (6 hours on cross)."
          ],
          [
            "Saturday",
            "Tomb Sealed",
            "The body of Christ remains in the grave."
          ],
          [
            "Sunday",
            "Resurrection Morning",
            "The empty tomb; the victory over death."
          ],
          [
            "40 Days",
            "Appearances",
            "Jesus proves He is alive to over 500 witnesses."
          ],
          [
            "Ascension",
            "Return to Glory",
            "Jesus returns to the right hand of the Father."
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            ...
            "Tacitus, Josephus, Lucian, Medical Analysis."
          ],
          [
            "2. Disciples' Belief",
            "Disciples believed He appeared to them alive.",
            "Early Creeds (1 Cor 15:3-5), Eyewitness testimony."
          ],
          [
            "3. Transformation",
            "Apostles were radically transformed.",
            "From fearful hiders to bold martyrs for the faith."
          ],
          [
            "4. The Empty Tomb",
            "The body was gone; location was well known.",
            "Early Jewish polemic admits it; discovered by women."
          ],
          [
            "5. Skeptics",
            "Conversion of James and Paul.",
            "James (unbelieving brother) and Paul (former enemy)."
          ],
          [
            "6. Proclamation",
            "Resurrection was preached immediately.",
            "Earliest sermons (Acts 2, 3, 10) center on this event."
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            ...
            "❌ Guards + Sealed tomb. ❌ Fearful disciples. ❌ No motive for a lie."
          ],
          [
            "Swoon Theory",
            "Jesus only fainted.",
            "❌ Roman execution was professional/fatal. ❌ Spear wound confirmed death."
          ],
          [
            "Hallucination",
            "Disciples had visions.",
            "❌ Groups cannot hallucinate collectively. ❌ Doesn't explain empty tomb."
          ],
          [
            "Legend Theory",
            "Story evolved over time.",
            "❌ Preached immediately. ❌ Early creeds date to 3-5 years after event."
          ]
        ]
      }
    ],
