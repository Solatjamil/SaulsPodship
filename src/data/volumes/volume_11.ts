...
export const volume_11: Volume = {
  "id": "11",
  "number": 11,
  "slug": "biblical-maps",
  "title": "Biblical Maps",
  "subtitle": "A Visual Atlas of Sacred Topography & Missionary Journeys",
  "overview": "A historical-geographical atlas mapping the Levant, the Fertile Crescent, Exodus routes, the Divided Monarchy, and the Greco-Roman world of the Apostles.",
  "category": "reference",
  ...
  "metaDescription": "Explore biblical maps and geography: Abraham's journey, Exodus routes, the Promised Land tribal allocations, and Apostle Paul's missionary travels in the Roman Empire.",
  "keywords": [
    "biblical maps",
    "geography of the bible",
    "paul missionary journeys map",
    "exodus route map",
  ...
  "summary": "Biblical Maps charts the physical geography, geopolitical borders, and travel routes of sacred history. Understanding the topography of the Ancient Near East and Greco-Roman Mediterranean illuminates the military, theological, and logistical context of biblical narratives.",
  "keyFacts": [
    "The land of Canaan sat at the strategic land bridge connecting the great superpowers of Egypt, Mesopotamia, and Anatolia.",
    "The Apostle Paul covered more than 10,000 miles by land and sea across the Roman Empire during his three recorded missionary journeys.",
    "The Jordan Rift Valley represents the lowest elevation on earth, plunging to over 1,400 feet below sea level at the Dead Sea.",
    "Biblical site identification has been substantially validated by modern topological archaeology, toponymy, and excavation."
  ],
  "faq": [
    {
      "q": "Why is geographical context vital for reading the Bible?",
      "a": "Topography shaped ancient travel, agriculture, military warfare, and covenantal boundaries; understanding places like Jerusalem's hills or the Sea of Galilee clarifies Jesus' ministry context."
    },
    {
      "q": "Where did the Exodus route actually travel?",
      "a": "While scholars debate traditional Mount Sinai in southern Sinai versus Midian in northwest Arabia, the biblical text traces a departure from Rameses through the Red Sea into the wilderness."
    },
    {
      "q": "How many missionary journeys did Paul make?",
      "a": "The Book of Acts records three distinct international missionary journeys spanning Galatia, Macedonia, Greece, and Asia Minor, followed by his voyage in custody to Rome."
    },
    {
      "q": "What was the significance of the 12 Tribes' land division?",
      "a": "Joshua divided Canaan according to divine lot and tribal size, fulfilling God's land promises to Abraham while establishing local stewardship and sanctuary cities."
    }
  ],
  "content": {
