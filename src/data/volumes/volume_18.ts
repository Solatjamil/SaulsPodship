...
export const volume_18: Volume = {
  "id": "18",
  "number": 18,
  "slug": "early-church-fathers-councils",
  "title": "Early Church Fathers & Councils",
  "subtitle": "Patristic Apologists, Ecumenical Synods & the Defense of Orthodoxy",
  "overview": "How the Apostolic Fathers, Apologists, and the Seven Ecumenical Councils (Nicaea, Constantinople, Ephesus, Chalcedon) codified orthodox Christian doctrine.",
  "category": "history",
  ...
  "metaDescription": "Explore Early Church Fathers and Councils: Apostolic fathers, Tertullian, Athanasius, Augustine, Council of Nicaea (325), and Chalcedon (451) defending orthodoxy.",
  "keywords": [
  ...
  "summary": "Early Church Fathers & Councils documents how the patristic church articulated, defended, and preserved apostolic doctrine against pervasive heresies. It details the pivotal theological debates of Nicaea (325 AD), Constantinople (381 AD), and Chalcedon (451 AD) that defined the Trinity and Christ's two natures.",
  "keyFacts": [
    "The Apostolic Fathers (e.g., Clement of Rome, Ignatius of Antioch, Polycarp) were disciples directly taught by the original Apostles.",
    "The Council of Nicaea in 325 AD rejected Arianism, affirming that the Son is homoousios ('of the same substance') with the Father.",
    "The Council of Chalcedon in 451 AD defined the Hypostatic Union: Christ is one person in two distinct natures, fully divine and fully human.",
    "Patristic apologists like Justin Martyr and Tertullian bridged Hebrew revelation with classical philosophy to defend Christians against Roman persecution."
  ],
  "faq": [
    {
      "q": "What is the difference between Apostolic Fathers and Church Fathers?",
      "a": "Apostolic Fathers lived in the generation directly following the Twelve Apostles (late 1st to mid-2nd century), while Church Fathers spans prominent theologians up to the 8th century."
    },
    {
      "q": "What did the Council of Nicaea decide?",
      "a": "Nicaea affirmed the absolute eternal deity of Jesus Christ against Arius, confessing Him as 'true God of true God, begotten not made, of one being with the Father.'"
    },
    {
      "q": "Why was the Council of Chalcedon so critical for Christology?",
      "a": "Chalcedon established that Jesus Christ possesses two complete natures—divine and human—without confusion, change, division, or separation, united in one divine person."
    },
    {
      "q": "Did the ecumenical councils invent new Christian doctrines?",
      "a": "No; the historic councils did not invent doctrine, but formalized the consensus of apostolic teaching in precise philosophical language to refute novel heresies."
    }
  ],
  "content": {
    ...
    "tables": [
      {
        ...
        "rows": [
          [
            "Ignatius",
            "🟦 Apostolic",
            "Christ’s deity, unity of Church",
            "Docetism"
          ],
          [
            "Polycarp",
          ...
          [
            "Athanasius",
            "🟥 Nicene",
            "Trinity defense, Nicene Creed",
            "Arianism"
          ],
          [
            "Augustine",
            "🟧 Post-Nicene",
            "Grace, original sin, theology",
            "Pelagianism"
          ]
        ]
      },
