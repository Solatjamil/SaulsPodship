...
export const volume_03: Volume = {
  "id": "03",
  "number": 3,
  "slug": "all-big-denominations-their-differences",
  "title": "All Big Denominations & Their Differences",
  "subtitle": "Theological Origins, Core Beliefs & Ecclesiastical Structures",
  "overview": "A comprehensive comparative study of major Christian traditions—Catholic, Orthodox, Lutheran, Reformed, Anglican, Baptist, and Pentecostal—analyzing core doctrines and historical branches.",
  "category": "history",
  ...
  "metaDescription": "Compare Christian denominations: Catholic, Orthodox, Protestant, Baptist, Pentecostal. Understand theological differences, church government, and shared historic creeds.",
  "keywords": [
  ...
  "summary": "All Big Denominations & Their Differences outlines the theological origins, authority structures, and sacramental views of the primary branches of Christianity. It traces the historic schisms of 1054 and 1517 while highlighting common confession in the historic ecumenical creeds.",
  "keyFacts": [
    "The Great Schism of 1054 formalized the separation between Eastern Orthodoxy and Western Roman Catholicism over the Filioque clause and papal supremacy.",
    "The Protestant Reformation of 1517 recovered the authority of Scripture (Sola Scriptura) and justification by faith alone (Sola Fide).",
    "Major traditions diverge on ecclesiology (episcopal, presbyterian, congregational) and the nature of the sacraments.",
    "All orthodox Christian denominations affirm the foundational doctrines of the Trinity and the Incarnation articulated in the Nicene Creed."
  ],
  "faq": [
    {
      "q": "What caused the first major split in Christian history?",
      "a": "The Great Schism of 1054 divided Eastern Orthodoxy and the Roman Catholic Church due to theological disputes over the Holy Spirit's procession and Rome's universal jurisdictional claims."
    },
    {
      "q": "What are the Five Solas of the Protestant Reformation?",
      "a": "The Five Solas are Sola Scriptura (Scripture alone), Sola Fide (faith alone), Sola Gratia (grace alone), Solus Christus (Christ alone), and Soli Deo Gloria (glory to God alone)."
    },
    {
      "q": "How do denominations differ on baptism?",
      "a": "Historic traditions practice pedobaptism (infant baptism as a covenant sign), while Baptist and Anabaptist traditions practice credobaptism (believer's baptism by immersion upon personal faith)."
    },
    {
      "q": "Do all denominations share the same Bible?",
      "a": "Protestants recognize 66 inspired books, while the Roman Catholic Church includes seven deuterocanonical books, and Eastern Orthodox Bibles include additional historical books."
    }
  ],
  "content": {
    ...
    "tables": [
      {
        ...
        "rows": [
          [
            ...
            "Episcopal (Bishops)",
            "Presbyterian (Elders)",
            "Congregational (Autonomous)",
            "Varies (often Episcopal or Cong.)"
          ],
          [
            "Baptism",
            "Infant baptism; seen as a sacrament that confers grace.",
            "Infant baptism; seen as a sign of the covenant.",
            "Believer's baptism only, by immersion.",
            "Believer's baptism; emphasis on Spirit baptism."
          ],
          [
            "Communion (Eucharist)",
            ...
            "Symbolic view; emphasis on healing/power."
          ],
          [
            "Spiritual Gifts",
            "Present, but often less emphasized in practice.",
            "Cessationist (Sign gifts ceased with apostles).",
            "Continuationist (Gifts continue).",
            "Continuationist (Gifts are a primary focus)."
          ],
          [
            "Scripture & Tradition",
            ...
            "Sola Scriptura (Scripture alone).",
            "Scripture is primary; value on personal experience."
          ]
        ]
      },
      {
