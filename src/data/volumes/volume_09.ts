...
export const volume_09: Volume = {
  "id": "09",
  "number": 9,
  "slug": "bible-book-writers",
  "title": "Bible Book Writers",
  "subtitle": "Human Authorship, Historical Contexts & Canonical Composition",
  "overview": "A scholarly and canonical profile of the human authors of the 66 biblical books—from Moses and David to the Prophets, Apostles, and early scribes.",
  "category": "reference",
  ...
  "metaDescription": "Who wrote the Bible? Comprehensive guide to the human authors of all 66 books, their historical eras, vocations, original languages, and inspiration.",
  "keywords": [
    "who wrote the bible",
    "bible authors",
  ...
  "summary": "Bible Book Writers profiles the human instruments God employed to pen the canonical scriptures across 1,500 years. It provides background on their vocations, historical eras, literary styles, and the dual nature of divine inspiration and human authorship.",
  "keyFacts": [
    "The Bible was penned by kings (David, Solomon), scholars (Moses, Paul), fishermen (Peter, John), and government officials (Nehemiah, Daniel).",
    "Moses is traditionally recognized as the primary author of the Pentateuch (the first five books of the Bible).",
    "The Apostle Paul authored thirteen canonical epistles, shaping early Christian theology and missionary ecclesiology.",
    "Historical-grammatical exegesis affirms that divine inspiration preserved the distinct personalities and vocabularies of each writer."
  ],
  "faq": [
    {
      "q": "How many authors wrote the Bible?",
      "a": "More than 40 human authors wrote the 66 canonical books over approximately 15 centuries across Israel, Babylon, Greece, and Rome under the inspiration of the Holy Spirit."
    },
    {
      "q": "Did Paul write the Book of Hebrews?",
      "a": "Ancient and modern scholars debate Hebrews' authorship; while early Western traditions favored Paul, vocabulary and style suggest an associate like Barnabas, Apollos, or Luke."
    },
    {
      "q": "What does divine inspiration mean?",
      "a": "As 2 Timothy 3:16 asserts ('God-breathed'), inspiration means the Holy Spirit superintended human authors so they wrote exactly what God intended without compromising human agency."
    },
    {
      "q": "How were anonymous books like Judges, Ruth, or Kings preserved?",
      "a": "Ancient Hebrew scribal and prophetic guilds carefully compiled and preserved communal historical records, prioritizing the divine authority of the message over personal attribution."
    }
  ],
  "content": {
    ...
    "tables": [
      {
        ...
        "rows": [
          [
            "The Pentateuch",
            "Moses (Traditional)",
            "Written during the 40-year wilderness wandering."
          ],
          [
            "The Deuteronomists",
            "Samuel / Jeremiah (Traditional)",
            "Records of the rise and fall of the Monarchy."
          ],
          [
            "The Post-Exilic History",
            "Ezra / Nehemiah",
            "Rebuilding the identity of Israel after the return from Babylon."
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            "Wisdom Literature",
            "Solomon, Job, Agur",
            "Focuses on the \"Fear of the LORD\" and practical living."
          ],
          [
            "The Major Prophets",
            "Isaiah, Jeremiah, Ezekiel",
            "Lengthy scrolls containing national and global warnings."
          ],
          [
            "The Minor Prophets",
            "The Twelve",
            "A unified collection of shorter prophetic oracles."
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            ...
            "Four multi-perspective eyewitness accounts of Jesus’ life, death, resurrection, and divinity."
          ],
          [
            "Acts of the Apostles",
            "Luke",
            "A historical chronicle of the early church, apostolic mission, and global expansion of the Gospel."
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            "The Journey Epistles",
            "Paul the Apostle",
            "Thirteen pastoral, theological, and corrections-focused letters written to local churches."
          ],
          [
            "The Pastoral Epistles",
            "Paul the Apostle",
            "Direct apostolic instructions to young leaders (Timothy, Titus) on church order and oversight."
          ]
        ]
      },
      {
        ...
        "rows": [
          [
            ...
            "Peter, John, James, Jude, Hebrews Writer",
            "Epistles addressed to the global church focusing on perseverance, theology, and ethical faith."
          ],
          [
            "The Apocalypse",
            "John the Beloved",
            "A comfort-giving, highly symbolic prophetic record of Christ's final victory over all evil kingdoms."
          ]
        ]
      }
    ],
